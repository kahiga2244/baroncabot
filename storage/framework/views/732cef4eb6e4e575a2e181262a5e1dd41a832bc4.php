...
<?php $__env->startSection('content'); ?>
   ...
   <section class="bg-light">
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-6">
               <img src="<?php echo asset('assets/images/1231221ot_19-compressed.jpg'); ?>" class="img-fluid" alt="FInd your investment">
            </div>
         </div>
      </div>
   </section>
      ...
      <div class="container">
         <div class="row g-5">
            ...
            <?php endif; ?>
               ...
               <center>
                  <a href="<?php echo route('page','projects'); ?>?utm_source=africa&utm_medium=cpc&utm_campaign=africa" class="btn btn-lg btn-outline-white btn-radius-24 mt-5"><i class="fal fa-info-circle"></i> View Portfolio</a>
               </center>
            </div>
         </div>
      </div>
   ...
   <section class="bg-light">
      <div class="container">
         <div class="row">
            <div class="col-lg-6">
               <img src="<?php echo asset('assets/images/Screenshot_19-1-compressed.jpg'); ?>" class="img-fluid" alt="FInd your investment">
            </div>
            <div class="col-lg-6">
               <div class="tax">
   ...
   <section class="">
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-6">
               <img src="<?php echo asset('assets/images/dsfgbfhdghnjg.jpg'); ?>" class="img-fluid" alt="FInd your investment">
            </div>
         </div>
      </div>
   </section>
   ...
   <section class="banner-section layout3-bg parallax-image" style="background-image: url(<?php echo e(asset('assets/images/bg1.jpg')); ?>);">
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-6">
               <img src="<?php echo asset('assets/images/Screenshot_21-compressed.jpg'); ?>" alt="trust" class="img-fluid">
            </div>
         </div>
      </div>
   </section>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/pages/africa.blade.php ENDPATH**/ ?>