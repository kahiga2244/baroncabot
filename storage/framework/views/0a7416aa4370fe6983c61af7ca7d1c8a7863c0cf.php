            ...
            <div class="col-lg-6 order-lg-1">
               ...
               This coaching never ends with your staff, as does the
                ...
                serious progress.
                  ...
                  <img src="<?php echo asset('assets/images/due6.png'); ?>" class="img-fluid" alt="">
               </div>
            </div>
            <div class="col-lg-5">
               <div class="provide-details">
                <img src="<?php echo asset('assets/images/due4.png'); ?>" class="img-fluid" alt="">
                <h1>Software</h1>
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="feature-2 dot-gradient">
            <?php $__currentLoopData = CMS::posts(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div>
                  <div class="card" style="width: 18rem;">
                    <?php if($blog->thumbnail): ?>
                    <img src="<?php echo Helpers::backend(); ?>/media/posts/<?php echo $blog->thumbnail; ?>" class="img-fluid" alt="">
                 <?php else: ?>
                    <img src="<?php echo asset('assets/images/placeholder.png'); ?>" class="img-fluid" alt="">
                 <?php endif; ?>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/pages/franchise.blade.php ENDPATH**/ ?>