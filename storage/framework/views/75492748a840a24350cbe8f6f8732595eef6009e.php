         ...
         <div class="row">
            <div class="col-md-12 due-section">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <img src="<?php echo asset('assets/images/due1.png'); ?>" alt="">
                  </div>
                  <div class="col-md-1">
                     <span class="dot"></span>
                  </div>
            ...
            <div class="col-md-12 due_arrow">
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <img src="<?php echo asset('assets/images/Vector1.png'); ?>" alt="">
                  </div>
               </div>
            </div>
            <div class="col-md-12 due-section">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                    <center><img src="<?php echo asset('assets/images/due2.png'); ?>" alt=""></center>
                  </div>
               </div>
            </div>
            <div class="col-md-12 due_arrow">
               <div class="row">
                  <div class="col-md-4">
                     <center><img src="<?php echo asset('assets/images/Vector1.png'); ?>" alt=""></center>
                  </div>
                  <div class="col-md-8">
            ...
            <div class="col-md-12 due-section">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <img src="<?php echo asset('assets/images/due3.png'); ?>" alt="">
                  </div>
                  <div class="col-md-1">
                     <span class="dot"></span>
                  </div>
            ...
            <div class="col-md-12 due-section">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <img src="<?php echo asset('assets/images/due4.png'); ?>" alt="">
                  </div>
               </div>
            </div>
            <div class="col-md-12 due_arrow">
            ...
            <div class="col-md-12 due-section">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <img src="<?php echo asset('assets/images/due5.png'); ?>" alt="">
                  </div>
                  <div class="col-md-1">
                     <span class="dot"></span>
                  </div>
            ...
            <div class="col-md-12 due-section">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <img src="<?php echo asset('assets/images/due6.png'); ?>" alt="">
                  </div>
               </div>
            </div>
         </div>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/pages/due-diligence.blade.php ENDPATH**/ ?>