...
<html lang="en">
   <head>
      ...
      <meta name="description" content="Baron &amp; Cabot - The only company with trained UK surveyors and data analysts, meaning you get the highest returns in the safest investments. Buy Property in London, Manchester, Birmingham. Leeds, Liverpool, Bolton, Coventry &amp; more.">
      <meta name="keywords" content="Baron cabot, Home,London, Manchester, Birmingham. Leeds, Liverpool, Bolton, Coventry">
      ...
      <meta name="twitter:title" content="Baron & Cabot">
      <meta name="twitter:description" content="Baron &amp; Cabot - The only company with trained UK surveyors and data analysts, meaning you get the highest returns in the safest investments. Buy Property in London, Manchester, Birmingham. Leeds, Liverpool, Bolton, Coventry &amp; more.">
      <meta name="twitter:image" content="<?php echo asset('assets/favicons/android-icon-192x192.png'); ?>">

      <!-- Facebook Meta -->
      <meta property="og:locale" content="en_US" />
      <meta property="og:url" content="<?php echo e(url('/')); ?>"/>
      <meta property="og:title" content="Baron & Cabot">
      <meta property="og:description" content="Baron &amp; Cabot - The only company with trained UK surveyors and data analysts, meaning you get the highest returns in the safest investments. Buy Property in London, Manchester, Birmingham. Leeds, Liverpool, Bolton, Coventry &amp; more.">
      <meta property="og:type" content="website">
      <meta property="og:image" content="<?php echo asset('assets/favicons/android-icon-192x192.png'); ?>" />
      <meta property="og:image:secure_url" content="<?php echo asset('assets/favicons/android-icon-192x192.png'); ?>">
      ...
      <link rel="apple-touch-icon" type="image/x-icon" href="<?php echo asset('assets/favicons/android-icon-192x192.png'); ?>">
      <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="<?php echo asset('assets/favicons/android-icon-192x192.png'); ?>">
      <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="<?php echo asset('assets/favicons/android-icon-192x192.png'); ?>">
      <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="<?php echo asset('assets/favicons/android-icon-192x192.png'); ?>">

      <!-- GOOGLE WEB FONT -->
      <link href="https://fonts.googleapis.com/css?family=Work+Sans:400,500,600" rel="stylesheet">

      <!-- BASE CSS -->
      <link href="<?php echo asset('assets/questions/css/bootstrap.min.css'); ?>" rel="stylesheet">
      <link href="<?php echo asset('assets/questions/css/menu.css'); ?>" rel="stylesheet">
      <link href="<?php echo asset('assets/questions/css/style.css'); ?>" rel="stylesheet">
      <link href="<?php echo asset('assets/questions/css/vendors.css'); ?>" rel="stylesheet">

      <!-- YOUR CUSTOM CSS -->
      <link href="<?php echo asset('assets/questions/css/custom.css'); ?>" rel="stylesheet">

      <!-- MODERNIZR MENU -->
      <script src="<?php echo asset('assets/questions/js/modernizr.js'); ?>"></script>
   ...
   <body>
         ...
         <div class="row row-height">
            <div class="col-xl-4 col-lg-4 content-left">
               <div class="content-left-wrapper">
                  <div id="social">
                     <ul>
                        <li><a href="https://www.facebook.com/baronandcabot" target="_blank"><i class="icon-facebook"></i></a></li>
                        <li><a href="https://twitter.com/BaronCabotLtd" target="_blank"><i class="icon-twitter"></i></a></li>
                        <li><a href="https://www.instagram.com/baron.cabot/" target="_blank"><i class="icon-instagram"></i></a></li>
                        <li><a href="https://www.linkedin.com/company/baron-cabot-research" target="_blank"><i class="icon-linkedin"></i></a></li>
                     </ul>
                  </div>
                  <!-- /social -->
                  <div>
                     <figure> <a href="<?php echo url('/'); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="204" height="150" viewBox="0 0 104 50" fill="none">
                     ...
                     <h2>Africans Investing In England</h2>
                     ...
                     <a href="https://baroncabot.com/africa" class="btn_1 rounded yellow" target="_parent">Find 0ut More</a>
                     <a href="#start" class="btn_1 rounded mobile_btn yellow">Start Now!</a>
                  </div>
                  <div class="copy">© 2022 Baron & Cabot</div>
               </div>
            ...
            <div class="col-xl-8 col-lg-8 content-right" id="start">
               <div id="wizard_container">
                  ...
                  <!-- /top-wizard -->
                  <form id="wrapped" method="post" enctype="multipart/form-data" action="<?php echo route('questions.submit'); ?>">
                     <?php echo csrf_field(); ?>
                     <div id="middle-wizard">
                        <!-- /Start Branch ============================== -->
                        <div class="step">
                           <h3 class="main_question">2). Let's get started. What UK cities are you most interested in buying in?*</h3>
                           <input type="hidden" name="email" value="<?php echo $email; ?>">
                           <input type="hidden" name="first_name" value="<?php echo $first_name; ?>">
                           <input type="hidden" name="last_name" value="<?php echo $last_name; ?>">
                           <input type="hidden" name="phone_number" value="<?php echo $phone_number; ?>">
                           <div class="form-group row">
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Not Sure
                                    <input type="checkbox" name="choose_city[]" value="Not Sure" class="required">
                                    <span class="checkmark"></span>
                                 </label>
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Birmingham
                                    <input type="checkbox" name="choose_city[]" value="Birmingham" class="required">
                                    <span class="checkmark"></span>
                                 </label>
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Manchester
                                    <input type="checkbox" name="choose_city[]" value="Manchester" class="required">
                                    <span class="checkmark"></span>
                                 </label>
                                 
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Leeds
                                    <input type="checkbox" name="choose_city[]" value="Leeds" class="required">
                                    <span class="checkmark"></span>
                                    
                                 </label>
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Liverpool
                                    <input type="checkbox" name="choose_city[]" value="Liverpool" class="required">
                                    <span class="checkmark"></span>
                                    
                                 </label>
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Nottingham
                                    <input type="checkbox" name="choose_city[]" value="Nottingham" class="required">
                                    <span class="checkmark"></span>
                                    
                                 </label>
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">London
                                    <input type="checkbox" name="choose_city[]" value="London" class="required">
                                    <span class="checkmark"></span>
                        ...
                        <div class=" submit">
                           <div>
                              <h3 class="main_question">3). When are you looking to buy?
                              </h3>
                              <div class="form-group row">
                                 <div class="col-md-12">
                        ...
                        <div class="submit step" id="end">
                           <div>
                              <h3 class="main_question">4). What is your estimated budget?
                              </h3>
                              <div class="form-group row">
                                 <div class="col-md-6">
                                    <label class="container_radio version_2">£0 - £35,000
                                       <input type="radio" name="budget" value="£0 - £35,000" class="required">
                                       <span class="checkmark"></span>
                                    </label>
                                 </div>
                                 <div class="col-md-6">
                                    <label class="container_radio version_2">£35,000 - £50,000
                                       <input type="radio" name="budget" value="£35,000 - £50,000" class="required">
                                       <span class="checkmark"></span>
                                    </label>
                                 </div>
                                 <div class="col-md-6">
                                    <label class="container_radio version_2">£50,000 - £100,000
                                       <input type="radio" name="budget" value="£50,000 - £100,000" class="required">
                                       <span class="checkmark"></span>
                                    </label>
                                 </div>
                                 <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <label class="container_radio version_2">£200,000 - £400,000
                                       <input type="radio" name="budget" value="£200,000 - £400,000" class="required">
                                       <span class="checkmark"></span>
                                    </label>
                                 </div>
                                 <div class="col-md-6">
                     ...
                     <div id="bottom-wizard">
                        ...
                        <button type="submit" name="process" class="submit" id="submitForm2">Submit</button>
                     </div>
                     <!-- /bottom-wizard -->
                  </form>
                  <div class="mt-5">
      ...
      <!-- COMMON SCRIPTS -->
      <script src="<?php echo asset('assets/questions/js/jquery-3.6.0.min.js'); ?>"></script>
      <script src="<?php echo asset('assets/questions/js/common_scripts.min.js'); ?>"></script>
      <script src="<?php echo asset('assets/questions/js/velocity.min.js'); ?>"></script>
      <script src="<?php echo asset('assets/questions/js/common_functions.js'); ?>"></script>
      <script src="<?php echo asset('assets/questions/js/file-validator.js'); ?>"></script>

      <!-- Wizard script-->
      <script src="<?php echo asset('assets/questions/js/func_1.js'); ?>"></script>
...
<?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/landings/questions_step_2.blade.php ENDPATH**/ ?>