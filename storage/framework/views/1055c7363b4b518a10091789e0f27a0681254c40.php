         ...
         <div class="row">
            <div class="col-lg-6 order-lg-1">
               <div class="service-img">
                  <img src="<?php echo asset('assets/images/ServicesIntrosection.png'); ?>" class="img-fluid" alt="">
               </div>
            </div>
            <div class="col-lg-5">
                     ...
                     <div class="col">
                        ...
                        <div class="row property-service column-space">
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="<?php echo asset('assets/images/mobile2.png'); ?>" alt="mobile2" style="width:50%">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="<?php echo asset('assets/images/independent-research.png'); ?>" alt="mobile2" style="width:50%">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="<?php echo asset('assets/images/candlestick_angle.png'); ?>" alt="mobile2" style="width:50%">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="<?php echo asset('assets/images/payment_with_check.png'); ?>" alt="mobile2" style="width:50%">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="<?php echo asset('assets/images/legal_processing.png'); ?>" alt="mobile2" style="width:50%">
                                 </center>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/pages/services.blade.php ENDPATH**/ ?>