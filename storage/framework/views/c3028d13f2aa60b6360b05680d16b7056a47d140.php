      ...
      <div class="container">
         <div class="row">
            <div class="col text-center not-found">
               <img src="<?php echo asset('assets/images/inner-pages/2.svg'); ?>" class="img-fluid" alt="">
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/errors/500.blade.php ENDPATH**/ ?>