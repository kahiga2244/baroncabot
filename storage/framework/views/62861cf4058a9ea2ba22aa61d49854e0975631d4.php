   ...
   <body>
         ...
         <div class="row row-height">
            <div class="col-xl-4 col-lg-4 content-left">
               <div class="content-left-wrapper">
                  ...
                  <div>
                     ...
                     <a href="https://baroncabot.com/africa" class="btn_1 rounded yellow" target="_blank">Find 0ut More</a>
            ...
            <div class="col-xl-8 col-lg-8 content-right" id="start">
               <div id="wizard_container">
                  ...
                  <!-- /top-wizard -->
                  <form method="post" enctype="multipart/form-data" action="<?php echo route('questions.submit.one'); ?>">
                     <?php echo csrf_field(); ?>
                     <div class="step">
                        <div>
                           <h3 class="main_question">1). Fill in your details *</h3>
                        </div>
                        <div class="row">
                           ...
                           <div class="col-md-6 mb-2">
                              <div class="form-group">
                                 <label>Enter last name <span class="text-danger">*</span></label>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label for="">Your contact number? <span class="text-danger">*</span></label>
                           ...
                           <div class="col-md-12">
                              ...
                              I agree to Baron & Cabot contacting me with information about relevant investment opportunities. I have read & agree with the Privacy Policy.<br> View Our <a href="https://baroncabot.com/terms-conditions" target="_blank"> Privacy Policy & Terms & Conditions</a>
                           </div>
                           <small class="text-danger mt-5">* This questions are required</small>
                           <center><small class="text-danger hide" id="phone_valid2">Your Phone Number is invalid</small></center>
                        </div>
                     </div>
                     <!-- /middle-wizard -->
                     <div id="bottom-wizard">
                        <a href="#" class="btn btn-primary" id="placeholderBtn">Save & Continue</a>
                        <button type="submit" class="btn btn-success hide" id="submitForm2">Save & Continue</button>
                     </div>
                     <!-- /bottom-wizard -->
                  </form>
                  <div class="mt-5">
      ...
      <script>
         var input2 = document.querySelector("#phone2"),
            ...
            placeholderBtn = document.querySelector("#placeholderBtn");
         ...
         input2.addEventListener('blur', function() {
            if(input2.value.trim()){
               if(intl2.isValidNumber()){
                  ...
                  phoneValid2.classList.add("hide");
                  placeholderBtn.classList.add("hide");
                  // $('#leadsForm2').submit(function(e) {
                  //    e.returnValue = true;
                  // });
               }else{
...
<?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/landings/questions.blade.php ENDPATH**/ ?>