               ...
               <ul class="list-unstyled">
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span>£<?php echo e(number_format($roi->total_equity_required)); ?></span>
                     </div>
                     <div class="progress" style="height: 5px;">
               ...
               <ul class="list-unstyled">
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span class="text-bold">£<?php echo number_format($roi->year_1); ?></span>
                     </div>
                     <div class="progress" style="height: 5px;">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 100%;" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                     </div>
                        ...
                        <div class="modal-content">
                           ...
                           <form action="<?php echo route('project.roi.changes'); ?>" method="POST">
                              ...
                              <div class="modal-body">
                                 ...
                                 <input type="text" name="property_url" value="<?php echo $url; ?>" required>
                        ...
                        <table class="table table-striped">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td><?php echo e($roi->final_capital_payment); ?></td>
                              </tr>
                              <tr>
                                 <td>2</td>
                        ...
                        <table class="table table-striped">
                           ...
                           <tbody>
                              ...
                              <tr class="table-primary">
                                 ...
                                 <td>
                                    <?php if($roi->mortgage_type == 'Interest Only'): ?>
                                 ...
                                 <tr class="table-info">
                                    ...
                                    <td><?php echo number_format($roi->year_1); ?> £</td>
                                 </tr>
                              </tr>
                           </tbody>
                        </table>
                        ...
                        <table class="table table-bordered table-striped table-responsive">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php echo number_format($roi->year_2); ?>
...
<?php $__env->startSection('scripts'); ?>
   ...
   <script>
      var month = <?php echo json_encode($monthValue); ?>

      var year = <?php echo json_encode($yearValue); ?>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/pages/roi-hold.blade.php ENDPATH**/ ?>