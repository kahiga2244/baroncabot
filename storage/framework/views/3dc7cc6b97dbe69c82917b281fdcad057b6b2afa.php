         ...
         <div class="row">
            <div class="col-lg-6 contact-img">
               <?php if($agent->isMobile()): ?>
                  <center><img src="<?php echo asset('assets/images/CU.png'); ?>" class="img-fluid ml-2" alt=""></center>
               <?php else: ?>
                  <img src="<?php echo asset('assets/images/CU.png'); ?>" class="img-fluid ml-2" alt="" style="width:80%">
               <?php endif; ?>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/pages/contact.blade.php ENDPATH**/ ?>