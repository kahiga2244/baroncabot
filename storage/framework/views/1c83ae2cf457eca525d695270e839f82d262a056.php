               ...
               <div class="user-about">
                  <div class="row">
                     <div class="col-xl-6 col-lg-6">
                        <center>
                           <img src="<?php echo asset('assets/images/Ourmission.png'); ?>" class="img-fluid" alt="">
                        </center>
                     </div>
                     <div class="col-xl-6 col-lg-6">
            ...
            <div class="col">
               ...
               <div class="user-about">
                  <div class="row">
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <center>
                           <img src="<?php echo asset('assets/images/DataAnalytics.png'); ?>" class="img-fluid" alt="" style="width:60%">
                        </center>
            ...
            <div class="col">
               ...
               <div class="user-about">
                  <div class="row">
                     <div class="col-xl-6 col-lg-6">
                        <center>
                           <img src="<?php echo asset('assets/images/Checklist.png'); ?>" class="img-fluid" alt="">
                        </center>
                     </div>
                     <div class="col-xl-6 col-lg-6">
                        <div class="about-content">
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/pages/who-we-are.blade.php ENDPATH**/ ?>