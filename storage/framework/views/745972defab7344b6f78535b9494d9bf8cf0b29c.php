<?php $__env->startSection('title'); ?>Baron & Cabot <?php $__env->stopSection(); ?>
<?php $__env->startSection('description'); ?>Baron & Cabot <?php $__env->stopSection(); ?>
<?php $__env->startSection('keywords'); ?>Baron & Cabot <?php $__env->stopSection(); ?>
<?php $__env->startSection('url'); ?><?php echo route('landing.page.leads1'); ?><?php $__env->stopSection(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
               <img src="<?php echo asset('assets/images/unsplash_PhYq704ffdA.jpg'); ?>" class="bg-img img-fluid" alt="">
            </div>
         </div>
      </div>
   </section>
         ...
         <div class="row">
            <div class="col">
               <div class="slide-3 brand-slider">
                  ...
                  <div>
                     <a href="javascript:void(0)" class="logo-box">
                        <img src="<?php echo asset('assets/images/200px-CNBC_logo.svg.png'); ?>" alt="" class="img-fluid" style="width:30%;">
                     </a>
                  </div>
                  <div>
                     <a href="javascript:void(0)" class="logo-box">
      ...
      <div class="container">
         <div class="row ratio_landscape">
            <div class="col">
                           ...
                           <div class="property-image">
                              ...
                              <div class="bottom-property">
                                 <div class="d-flex" style="margin-bottom: 80px">
                                    <div>
                                       <h5><a href="<?php echo route('project.details',$property->url); ?>"><?php echo $property->product_name; ?></a></h5>
                                       <h6>£<?php echo number_format($property->price); ?>* <small>/ start from</small></h6>
                                    </div>
                                    <button type="button" class="btn btn-gradient color-6 mt-3" onclick="document.location='<?php echo route('project.details',$property->url); ?>'">Details</button>
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <center><a href="<?php echo route('page','projects'); ?>" target="_blank" class="btn btn-outline-dark">View More Projects</a></center>
            </div>
         </div>
      </div>
   </section>
                        ...
                        <div class="row property-service column-space">
                           <div class="col-xl-3 col-md-6 wow fadeInUp">
                              <div class="service-box text-center" >
                                 <center>
                                    <img src="<?php echo asset('assets/images/scatter_chart.png'); ?>" alt="scatter_chart" style="width:50%">
                                 </center>
                           ...
                           <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="<?php echo asset('assets/images/Asset2.svg'); ?>" alt="mobile2" style="width:50%">
                                 </center>
                           ...
                           <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="<?php echo asset('assets/images/arrow_up_wtih_chart.png'); ?>" alt="mobile2" style="width:50%">
                                 </center>
                           ...
                           <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="<?php echo asset('assets/images/property_management.png'); ?>" alt="mobile2" style="width:50%">
                                 </center>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/landings/lead2.blade.php ENDPATH**/ ?>