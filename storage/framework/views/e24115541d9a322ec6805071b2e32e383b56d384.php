...
<?php $__env->startSection('content'); ?>
   <!-- breadcrumb start -->
   <section class="breadcrumb-section p-0" <?php if($agent->isMobile()): ?>style="height: 110vh;"<?php endif; ?>>
            ...
            <div class="row mt-5">
               ...
               <div class="col-md-8">
                  <div class="row">
                     ...
                     <div class="col-md-4 mb-5">
                        <center>
                           <img src="<?php echo asset('assets/images/mobile2.png'); ?>" alt="scatter_chart" style="width:50%">
                        </center>
                        <h4 class="mt-3 text-center"><a class="text-white" href="#">Research Developments</a></h4>
                     </div>
                     <div class="col-md-4 mb-5">
                        <center>
                           <img src="<?php echo asset('assets/images/arrow_up_wtih_chart.png'); ?>" alt="scatter_chart" style="width:50%">
                        </center>
                        <h4 class="mt-3 text-center"><a class="text-white" href="#">Mortgage Supply</a></h4>
                     </div>
                     <div class="col-md-4">
                        <center>
                           <img src="<?php echo asset('assets/images/property_management.png'); ?>" alt="scatter_chart" style="width:50%">
                        </center>
                        <h4 class="mt-3 text-center"><a class="text-white" href="#">Property Management</a></h4>
                     </div>
                     <div class="col-md-4">
                        <center>
                           <img src="<?php echo asset('assets/images/payment.png'); ?>" class="mt-2" alt="scatter_chart" style="width:50%">
                        </center>
                        <h4 class="mt-3 text-center"><a class="text-white" href="#">UK Bank Account Set Up</a></h4>
                     </div>
                     <div class="col-md-4">
                        <center>
                           <img src="<?php echo asset('assets/images/independent-research.png'); ?>" alt="scatter_chart" style="width:50%">
                        </center>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/landings/lead1.blade.php ENDPATH**/ ?>