...
<html lang="en">
   ...
   <head>
      ...
      <link rel="apple-touch-icon" sizes="76x76" href="<?php echo asset('assets/landing/v2/img/apple-icon.png'); ?>" />
      <link rel="icon" type="image/png" href="<?php echo asset('assets/landing/v2/img/favicon.png'); ?>" />
      ...
      <link href="<?php echo asset('assets/landing/v2/css/bootstrap.min.css'); ?>" rel="stylesheet" />
      <link href="<?php echo asset('assets/landing/v2/css/material-bootstrap-wizard.css'); ?>" rel="stylesheet" />

      <link href="<?php echo asset('assets/landing/v2/css/demo.css'); ?>" rel="stylesheet" />
               ...
               <div class="col-sm-8 col-sm-offset-2">
                  ...
                  <div class="wizard-container">
                     ...
                     <div class="card wizard-card" data-color="purple" id="wizard">
                        <form  method="post" enctype="multipart/form-data" action="<?php echo route('questions.submit'); ?>">
                           <?php echo csrf_field(); ?>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select Liverpool">
                                          ...
                                          <div class="icon">
                                             <img src="<?php echo asset('assets/images/Liverpool.jpg'); ?>" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Liverpool</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select Nottingham.">
                                          ...
                                          <div class="icon">
                                             <img src="<?php echo asset('assets/images/Nottingham.jpg'); ?>" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Nottingham</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select London.">
                                          ...
                                          <div class="icon">
                                             <img src="<?php echo asset('assets/images/london.jpg'); ?>" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>London</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select not sure.">
                                          <input type="checkbox" name="city" value="London">
                                          <div class="icon">
                                             <img src="<?php echo asset('assets/images/notsure.jpg'); ?>" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Not sure</h6>
                                       </div>
                                    </div>
   ...
   <script src="<?php echo asset('assets/landing/v2/js/jquery-2.2.4.min.js'); ?>" type="text/javascript"></script>
   <script src="<?php echo asset('assets/landing/v2/js/bootstrap.min.js'); ?>" type="text/javascript"></script>
   <script src="<?php echo asset('assets/landing/v2/js/jquery.bootstrap.js'); ?>" type="text/javascript"></script>

   <script src="<?php echo asset('assets/landing/v2/js/demo.js'); ?>" type="text/javascript"></script>
   <script src="<?php echo asset('assets/landing/v2/js/material-bootstrap-wizard.js'); ?>" type="text/javascript"></script>

   <script src="<?php echo asset('assets/landing/v2/js/jquery.validate.min.js'); ?>" type="text/javascript"></script>
...
<?php /**PATH /home/stone/Desktop/Projects/PHP/baroncabot/resources/views/landings/questions2.blade.php ENDPATH**/ ?>