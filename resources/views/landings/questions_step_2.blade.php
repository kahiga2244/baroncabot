...
<html lang="en">
   <head>
      ...
      <meta name="twitter:image" content="{!! asset('assets/favicons/android-icon-192x192.png') !!}">
      ...
      <meta property="og:image" content="{!! asset('assets/favicons/android-icon-192x192.png') !!}" />
      <meta property="og:image:secure_url" content="{!! asset('assets/favicons/android-icon-192x192.png') !!}">
      ...
      <link rel="apple-touch-icon" type="image/x-icon" href="{!! asset('assets/favicons/android-icon-192x192.png') !!}">
      <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="{!! asset('assets/favicons/android-icon-192x192.png') !!}">
      <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="{!! asset('assets/favicons/android-icon-192x192.png') !!}">
      <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="{!! asset('assets/favicons/android-icon-192x192.png') !!}">
   ...
   <body>
         ...
         <div class="row row-height">
            ...
            <div class="col-xl-8 col-lg-8 content-right" id="start">
               <div id="wizard_container">
                  ...
                  <!-- /top-wizard -->
                  <form id="wrapped" method="post" enctype="multipart/form-data" action="{!! route('questions.submit') !!}">
                     @csrf
                     <div id="middle-wizard">
                        ...
                        <div class="step">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6 container_radio">
                                 ...
                                 {{-- <img src="{!! asset('assets/images/Manchester.webp') !!}" alt="" class="img-fluid check-image"> --}}
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Leeds
                                    <input type="checkbox" name="choose_city[]" value="Leeds" class="required">
                                    <span class="checkmark"></span>
                                    {{-- <img src="{!! asset('assets/images/Leeds.jpg') !!}" alt="" class="img-fluid check-image"> --}}
                                 </label>
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Liverpool
                                    ...
                                    <span class="checkmark"></span>
                                    {{-- <img src="{!! asset('assets/images/Liverpool.jpg') !!}" alt="" class="img-fluid check-image"> --}}
                                 </label>
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">Nottingham
                                    ...
                                    <span class="checkmark"></span>
                                    {{-- <img src="{!! asset('assets/images/Nottingham.jpg') !!}" alt="" class="img-fluid check-image"> --}}
                                 </label>
                              </div>
                              <div class="col-md-6 container_radio">
                                 <label class="container_radio version_2">London
                                    ...
                                    <span class="checkmark"></span>
                                    {{-- <img src="{!! asset('assets/images/london.jpg') !!}" alt="" class="img-fluid check-image"> --}}
                                 </label>
                              </div>
                              {{-- <div class="col-md-6 container_radio">
                                 <label class=" version_2 ">Not Sure
                                    <input type="checkbox" name="city" value="not sure" class="required">
                                    <span class="checkmark"></span>
                                 </label>
                                 <img src="{!! asset('assets/images/notsure.jpg') !!}" alt="" class="img-fluid check-image">
                              </div> --}}
                           </div>
                        ...
                        <!-- /Start Branch ============================== -->
                        {{-- <div class="step">
                           <h3 class="main_question">3). Have you invested in buy to let property before?</h3>
      ...
      <!-- COMMON SCRIPTS -->
      <script src="{!! asset('assets/questions/js/jquery-3.6.0.min.js') !!}"></script>
      <script src="{!! asset('assets/questions/js/common_scripts.min.js') !!}"></script>
      <script src="{!! asset('assets/questions/js/velocity.min.js') !!}"></script>
      <script src="{!! asset('assets/questions/js/common_functions.js') !!}"></script>
      <script src="{!! asset('assets/questions/js/file-validator.js') !!}"></script>

      <!-- Wizard script-->
      <script src="{!! asset('assets/questions/js/func_1.js') !!}"></script>
