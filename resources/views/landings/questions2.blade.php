...
<html lang="en">
   ...
   <head>
      ...
      <link rel="apple-touch-icon" sizes="76x76" href="{!! asset('assets/landing/v2/img/apple-icon.png') !!}" />
      <link rel="icon" type="image/png" href="{!! asset('assets/landing/v2/img/favicon.png') !!}" />
      ...
      <link href="{!! asset('assets/landing/v2/css/bootstrap.min.css') !!}" rel="stylesheet" />
      <link href="{!! asset('assets/landing/v2/css/material-bootstrap-wizard.css') !!}" rel="stylesheet" />

      <link href="{!! asset('assets/landing/v2/css/demo.css') !!}" rel="stylesheet" />
   ...
   <body>
      <div class="image-container set-full-height" style="background-image: url('https://cms.baroncabot.com/media/sliders/2vTteg.jpg')">
         <div class="container">
            <div class="row">
               <div class="col-sm-8 col-sm-offset-2">
                  ...
                  <div class="wizard-container">
                     ...
                     <div class="card wizard-card" data-color="purple" id="wizard">
                        <form  method="post" enctype="multipart/form-data" action="{!! route('questions.submit') !!}">
                           @csrf
                           <div class="wizard-header">
                              <h3 class="wizard-title">Africans Investing In England</h3>
                              <h5>We will get you a mortgage, with all property deeds in your name, tenant the property for you, and protect you with regulations</h5>
                           </div>
                           <div class="wizard-navigation">
                              <ul>
                                 <li><a href="#location" data-toggle="tab">Cities</a></li>
                                 ...
                                 <li><a href="#when" data-toggle="tab">Buying time</a></li>
                           ...
                           <div class="tab-content">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select Birmingham">
                                          <input type="checkbox" name="city" value="Birmingham">
                                          <div class="icon">
                                             <img src="{!! asset('assets/images/Birmingham.jpg') !!}" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Birmingham</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select Manchester.">
                                          <input type="checkbox" name="city" value="Manchester">
                                          <div class="icon">
                                             <img src="{!! asset('assets/images/Manchester.webp') !!}" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Manchester</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select Leeds.">
                                          <input type="checkbox" name="city" value="Leeds">
                                          <div class="icon">
                                             <img src="{!! asset('assets/images/Leeds.jpg') !!}" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Leeds</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select Liverpool">
                                          <input type="checkbox" name="city" value="Liverpool">
                                          <div class="icon">
                                             <img src="{!! asset('assets/images/Liverpool.jpg') !!}" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Liverpool</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select Nottingham.">
                                          <input type="checkbox" name="city" value="Nottingham">
                                          <div class="icon">
                                             <img src="{!! asset('assets/images/Nottingham.jpg') !!}" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Nottingham</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select London.">
                                          <input type="checkbox" name="city" value="London">
                                          <div class="icon">
                                             <img src="{!! asset('assets/images/london.jpg') !!}" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>London</h6>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select not sure.">
                                          <input type="checkbox" name="city" value="London">
                                          <div class="icon">
                                             <img src="{!! asset('assets/images/notsure.jpg') !!}" alt="" class="img-fluid check-image" style="height: 200px; width:200px">
                                          </div>
                                          <h6>Not sure</h6>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                       <div class="col-sm-4 col-sm-offset-2">
                                          <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select this option if you have a house.">
                                             <input type="radio" name="invested_before" value="Yes">
                                             <div class="icon" style="height: 110px; width:110px">
                                       ...
                                       <div class="col-sm-4">
                                          <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select this option if you have an appartment">
                                             <input type="radio" name="invested_before" value="No">
                                             <div class="icon" style="height: 110px; width:110px">
                              ...
                              <div class="tab-pane" id="size">
                                 <h4 class="info-text">3). Choose highest profitable property?</h4>
                                    ...
                                    <div class="col-sm-6">
                                       <div class="input-group">
                                          ...
                                          <div class="form-group label-floating">
                                             <label class="control-label">Your Names</label>
         ...
         <div class="footer">
            <div class="container text-center">
               &copy; <a href="#">Baron & Cabot</a>.</a>
            </div>
         </div>
      </div>
   </body>

   <script src="{!! asset('assets/landing/v2/js/jquery-2.2.4.min.js') !!}" type="text/javascript"></script>
   <script src="{!! asset('assets/landing/v2/js/bootstrap.min.js') !!}" type="text/javascript"></script>
   <script src="{!! asset('assets/landing/v2/js/jquery.bootstrap.js') !!}" type="text/javascript"></script>

   <script src="{!! asset('assets/landing/v2/js/demo.js') !!}" type="text/javascript"></script>
   <script src="{!! asset('assets/landing/v2/js/material-bootstrap-wizard.js') !!}" type="text/javascript"></script>

   <script src="{!! asset('assets/landing/v2/js/jquery.validate.min.js') !!}" type="text/javascript"></script>
