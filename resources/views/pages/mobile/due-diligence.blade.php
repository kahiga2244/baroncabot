                        ...
                        <div class="row property-service column-space">
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="{!! asset('assets/images/due1.png') !!}" alt="" class="img-fluid">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="{!! asset('assets/images/due2.png') !!}" alt="" class="img-fluid">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="{!! asset('assets/images/due3.png') !!}" alt="" class="img-fluid">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="{!! asset('assets/images/due4.png') !!}" alt="" class="img-fluid">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="{!! asset('assets/images/due5.png') !!}" alt="" class="img-fluid">
                                 </center>
                           ...
                           <div class="col-xl-4 col-md-6 wow fadeInUp">
                              <div class="service-box text-center">
                                 <center>
                                    <img src="{!! asset('assets/images/due6.png') !!}" alt="" class="img-fluid">
                                 </center>
