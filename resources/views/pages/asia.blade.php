...
@section('image'){!! asset('assets/images/Asia_orthographic_projection.svg.png') !!}@endsection
@section('article')
...
@section('content')
   <!-- breadcrumb start -->
   <section class="breadcrumb-section p-0" @if($agent->isMobile()) style="height:100%;" @endif>
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-6">
               <div class="video-details" @if($agent->isMobile()) style="margin-bottom:120px" @endif>
         ...
         <div class="row">
            ...
            <div class="col-lg-6">
               <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#video">
                  <img src="{!! asset('assets/images/bbcmark.jpg') !!}" class="img-fluid" alt="Find your investment">
               </a>
            </div>
         </div>
      </div>
      ...
      <div class="container">
         <div class="row g-5">
            ...
            @endif
               ...
               <center>
                  <a href="{!! route('page','projects') !!}?utm_source=Asia&utm_medium=cpc&utm_campaign=Asia" class="btn btn-lg btn-outline-white btn-radius-24 mt-5"><i class="fal fa-info-circle"></i> View Portfolio</a>
               </center>
            </div>
         </div>
      </div>
   ...
   <section class="bg-light">
      <div class="container">
         <div class="row">
            <div class="col-lg-6">
               <img src="{!! asset('assets/images/755d0761-adasdasd.jpeg') !!}" class="img-fluid" alt="You May Not Need To Pay tax">
            </div>
            <div class="col-lg-6">
               <div class="tax">
   ...
   <section class="">
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-6">
               <img src="{!! asset('assets/images/asia-mortgage.jpg') !!}" class="img-fluid" alt="FInd your investment">
            </div>
         </div>
      </div>
   </section>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-6">
               ...
               <h4 class="text-white"><a href="{!! asset('assets/images/globaltransparency.png') !!}">Global Real Estate Transparency Index, 2022</a></h4>
               {{-- <a href="{!! asset('assets/images/globaltransparency.png') !!}" target="_blank" class="mb-3">
                  <img src="{!! asset('assets/images/d2ae6937-0ba0-4ee6-84de-dca2e530ec89.jpeg') !!}" alt="" class="img-fluid">
               </a> --}}
               <br><br>
            </div>
            <div class="col-lg-6">
               <img src="{!! asset('assets/images/trust.png') !!}" alt="trust" class="img-fluid">
            </div>
         </div>
      </div>
   </section>
