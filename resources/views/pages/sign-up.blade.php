...
@section('content')
   ...
   <section class="breadcrumb-section p-0" style="min-height: 450px;">
    <img src="{!! asset('assets/images/seminar.png') !!}" class="bg-img img-fluid" alt="">
       ...
       {{-- <div class="col-md-5" >
        <div class="card text-center" style="width: 25rem;">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm">
              <img src="{!! asset('assets/svg/clock.svg') !!}" class="" alt="">
              </div>
            ...
            <div class="row">
              <div class="col-sm">
              <img src="{!! asset('assets/svg/calendar-check.svg') !!}" class="" alt="">
              </div>
            ...
            <div class="row">
              <div class="col-sm">
              <img src="{!! asset('assets/svg/geo-alt.svg') !!}" class="" alt="">
              </div>
              <div class="col-md"><h6>EKO HOTEL LAGOS</h6> </div>
            </div>
            <br>
            <div class="row" style="margin-top: auto;">
              <button type="button" class="btn btn ">RESERVE YOUR SPOT</button>
            </div>
          </div>
        </div>
     </div> --}}
  ...
  <div class="container">
     <div class="row">
      <h2 class="text-center mb-5">Our Expert Speakers</h2>
        <div class="col-6">
          <div class="card">
            <img src="{!! asset('assets/images/6efad6257b4c14fb.jpg') !!}" class="card-img-top" alt="">
            <div class="card-body">
        ...
        <div class="col-6">
            <div class="card">
              <img src="{!! asset('assets/images/James2.png') !!}" class="card-img-top" alt="">
              <div class="card-body">
                      ...
                      <form action="{{ url ('send-email') }}" method="post" novalidate="novalidate">
                        ...
                        <div class="form-group">
                          ...
                          {{-- <div class="form-group">
                            ...
                            <input id="message" name="message" type="text" class="form-control message valid" data-val="true"  autocomplete="message" aria-required="true" aria-invalid="false" aria-describedby="message-error">
                            <span class="help-block field-validation-valid" data-valmsg-for="message" data-valmsg-replace="true"></span>
                        </div> --}}
                          <div>
          ...
          <div class="row">
            <div class="col-sm-6" >
              <div class="card text-center">
                <div class="card-body">
                  <img src="{!! asset('assets/images/arrow_up_wtih_chart.png') !!}" class="" alt="" style="width: 73px;">
            ...
            <div class="col-sm-6">
              <div class="card text-center">
                <div class="card-body">
                  <img src="{!! asset('assets/images/due2.png') !!}" class="" alt="" style="width: 115px;">
                  <p class="card-text">
            ...
            <div class="col d-flex justify-content-center">
              <div class="card  text-center" >
                <div class="card-body">
                  <img src="{!! asset('assets/images/Checklist.png') !!}" class="" alt="" style="width: 75px;">
