                     ...
                     <div class="card overflow-hidden">
                        <div class="card-body">
                           ...
                           <div>
                              ...
                              @endphp
                              <span class="h4">£{!! number_format($roi5) !!}</span>
                     ...
                     <div class="card overflow-hidden">
                        <div class="card-body">
                           ...
                           <div>
                              ...
                              @endphp
                              <span class="h4">£{!! number_format($roi10) !!}</span>
               ...
               <ul class="list-unstyled">
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span>£{!! number_format($PaymentOnReservationAndExchange) !!}</span>
                     </div>
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span>£{!! number_format($PaymentOnCompletion) !!}</span>
                     </div>
                     <div class="progress" style="height: 5px;">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 100%;" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                     </div>
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span>£{{ number_format($totalEquityRequired) }}</span>
                     </div>
                     <div class="progress" style="height: 5px;">
               ...
               <ul class="list-unstyled">
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span>£{{ number_format($mortgageAmount) }}</span>
                     </div>
                     <div class="progress" style="height: 5px;">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 100%%;" aria-valuenow="89" aria-valuemin="0" aria-valuemax="100"></div>
                     </div>
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span>£{!! number_format($monthlyIncome) !!}</span>
                     </div>
                     <div class="progress" style="height: 5px;">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 100%;" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                     </div>
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        <span>Mortgage type - {{ $cashflow->mortgage_type }}</span>
                        <span>
                           £@if($cashflow->mortgage_type == 'Interest Only'){!! number_format(abs($ipmt)) !!}@else 0 @endif
                        </span>
                     </div>
                     <div class="progress" style="height: 5px;">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 100%;" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span class="text-bold">£{!! number_format(abs(abs($ipmt) - $monthlyIncome )) !!}</span>
                     </div>
                     <div class="progress" style="height: 5px;">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 100%;" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                     </div>
                        ...
                        <table class="table table-striped">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td> {!! $cashflow->exchange_deposit_percentage !!}% of purchase price (£{!! number_format($exchangeDeposit) !!})</td>
                              </tr>
                              <tr>
                                 <td>3</td>
                        ...
                        <table class="table table-striped">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>£{!! $cashflow->get_ground !!}</td>
                              </tr>
                              <tr>
                                 <td>2</td>
                                 <td>Estimated service charge</td>
                                 <td>{!! number_format($cashflow->estimated_service_charge_rate) !!} psf</td>
                              ...
                              <tr>
                                 ...
                                 <td>£{!! number_format($cashflow->management_fee) !!}</td>
                              </tr>
                              <tr>
                                 <td>4</td>
                                 <td>Ground rent</td>
                                 <td>{!! number_format($cashflow->ground_rent) !!} per month </td>
                                 <td>£{!! number_format($cashflow->ground_rent) !!}</td>
                              </tr>
                              <tr>
                                 <td>5</td>
                              ...
                              <tr class="table-primary">
                                 ...
                                 <td>£@if($cashflow->mortgage_type == 'Interest Only'){!! number_format(abs($ipmt)) !!}@else 0 @endif
                                 </td>
                                 <tr class="table-info">
                                    <td></td>
                                    <td></td>
