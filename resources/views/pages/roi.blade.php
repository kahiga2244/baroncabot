               ...
               <table class="table table-striped">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>2</td>
                        <td>Mortgage Rate</td>
                        <td class="table-info"><b>{!! $roi->mortgage_rate !!}%</b></td>
                     </tr>
                     <tr>
                        <td>3</td>
      ...
      <div class="container">
         ...
         <div class="row">
               ...
               <ul class="list-unstyled">
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span>£{{ number_format($roi->equity_required ) }}</span>
                     </div>
                     <div class="progress" style="height: 5px;">
               ...
               <ul class="list-unstyled">
                  ...
                  <li class="mb-3 mt-3">
                     <div class="d-flex justify-content-between">
                        ...
                        <span class="text-bold">£{!! number_format($roi->monthly_income - $roi->mortgage_repayment) !!}</span>
                     </div>
                     <div class="progress" style="height: 5px;">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 100%;" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                     </div>
            ...
            {{-- <div class="col-md-12 mt-5" style="height: 400px">
               <h3 class="text-center mt-5">Capital Appreciation</h3>
      ...
      <div class="container">
         <div class="faq-questions">
            <div id="accordion" class="accordion">
                        ...
                        <table class="table table-striped">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>{{ number_format($roi->final_capital_payment) }}</td>
                              </tr>
                              <tr>
                                 <td>2</td>
                           ...
                           <tbody>
                              ...
                              <tr class="table-primary">
                                 ...
                                 <tr class="table-info">
                                    ...
                                    <td>{!! number_format($roi->monthly_income - $roi->mortgage_repayment) !!} £</td>
                                 </tr>
                              </tr>
                           </tbody>
                        </table>
               ...
               {{-- <div class="card">
                  <div class="card-header">
                     <a class="collapsed card-link" data-bs-toggle="collapse" href="#monthlyCashPosition">ANNUAL NET MONTHLY CASH POSITION</a>
                  </div>
                  <div id="monthlyCashPosition" class="collapse" data-bs-parent="#accordion">
                     <div class="card-body">
                        <table class="table table-bordered table-striped table-responsive">
                           ...
                           <tbody>
                              <tr>
                                 <td><b>Net Monthly Cash Position</b></td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_1) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_2) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_3) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_4) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_5) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_6) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_7) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_8) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_9) !!}</td>
                                 <td>{!! number_format($roi->net_monthly_cash_position_year_10) !!}</td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
                        ...
                        <table class="table table-bordered table-striped table-responsive">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>{!! number_format($roi->property_value_year_1) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_2) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_3) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_4) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_5) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_6) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_7) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_8) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_9) !!}</td>
                                 <td>{!! number_format($roi->property_value_year_10) !!}</td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
                        ...
                        <table class="table table-bordered table-striped table-responsive">
                           ...
                           <tbody>
                              ...
                              <tr style="display: none">
                                 ...
                                 <td>{!! number_format($roi->rent_escalation_1,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_2,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_3,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_4,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_5,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_6,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_7,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_8,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_9,2) !!}</td>
                                 <td>{!! number_format($roi->rent_escalation_10,2) !!}</td>
                              </tr>

                              {{-- Rental Income --}}
                              <tr>
                                 <td><b>Rental Income</b></td>
                                 <td>{!! number_format($roi->rental_income_1) !!}</td>
                                 <td>{!! number_format($roi->rental_income_2) !!}</td>
                                 <td>{!! number_format($roi->rental_income_3) !!}</td>
                                 <td>{!! number_format($roi->rental_income_4) !!}</td>
                                 <td>{!! number_format($roi->rental_income_5) !!}</td>
                                 <td>{!! number_format($roi->rental_income_6) !!}</td>
                                 <td>{!! number_format($roi->rental_income_7) !!}</td>
                                 <td>{!! number_format($roi->rental_income_8) !!}</td>
                                 <td>{!! number_format($roi->rental_income_9) !!}</td>
                                 <td>{!! number_format($roi->rental_income_10) !!}</td>
                              </tr>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    {!! number_format($roi->annual_1) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_2) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_3) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_4) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_5) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_6) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_7) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_8) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_9) !!}
                                 </td>
                                 <td>
                                    {!! number_format($roi->annual_10) !!}
                                 </td>
                              </tr>
                           </tbody>
                        </table>
   ...
   <section class="property-section bg-light" id="Summary">
      <div class="container">
         <center>
            ...
            <a href="">{!! route('project.roi',$url) !!}?session={{$session}}</a>
         </center>
      </div>
   </section>
...
@section('scripts')
   ...
   <script>
      var yearEnd       = {!! json_encode($propertyValueYearEnd) !!}
      var escalationValue = {!! json_encode($escalationValue) !!}
   ...
   <script>
      var capitalAppreciationValue       = {!! json_encode($capitalAppreciationValue) !!}
