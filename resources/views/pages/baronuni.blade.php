...
<section class="breadcrumb-section p-0">
  <img src="{!! asset('assets/images/Campus.jpg') !!}" class="bg-img img-fluid" alt="">
  <div class="container">
           ...
           <div class="btn">
             <a class="blue" href="#" onclick="openPopup()">Learn More</a>
              ...
              <div class="popup" id="popup">
               {{-- <img src="{!! asset('assets/images/404-tick.png') !!}"> --}}
               <h2>Thank You!</h2>
        ...
        <a href="https://www.youtube.com/watch?v=xgC5yviFoxs&t=10s"><button type="button" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Watch video</button></a>
                       ...
                       <div class="col-xl-3 col-md-6 wow fadeInUp">
                        <div class="service-box text-center" >
                            ...
                            {{-- <img src="{!! asset('assets/images/property.jpg') !!}"  alt="" style="width: 200px; height: 200px;"> --}}
                            <img src="https://via.placeholder.com/300x230">
                    ...
                    <div class="row property-service column-space">
                       <div class="col-xl-4 col-md-6 wow fadeInUp">
                          <div class="service-box text-center" >
                             <center> --}}
                              {{-- <img src="{!! asset('assets/images/property.jpg') !!}"  alt="" style="width: 200px; height: 200px;"> --}}
                              {{-- <i class="fas fa-house fa-8x"></i>
                              <i class="fa-solid fa-house-turret"></i>
                             </center>
                             <h3 class="mt-3"><a href="#">Who can get a mortgage in uk?</a></h3>
                             <p>One make creepeth, man bearing their firmament wont great heaven.</p>
                             <div class="property-btn d-flex">
                       ...
                       <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                          <div class="service-box text-center">
                             <center>
                              <i class="fas fa-house fa-8x"></i> --}}
                              {{-- <i class="fas fa-house-building fa-8x"></i> --}}
                             {{-- </center>
                             <h3 class="mt-3"><a href="#">How do UK mortgages work?</a></h3>
                             <p>One make creepeth, man bearing their firmament wont great heaven.</p>
                             <div class="property-btn d-flex">
                       ...
                       <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                          <div class="service-box text-center">
                             ...
                             <h3 class="mt-3"><a href="#">What is net yield and gross yield</a></h3>
                             <p>One make creepeth, man bearing their firmament wont great heaven</p>
                             <div class="property-btn d-flex">
    ...
    <div class="container">
      <div class="row">
        ...
        <form class="text-center" name="">
          ...
          <button type="submit"><img src="{!! asset('assets/images/send-icon.png') !!}" width="30px"></button>
         </form>
         ...
         <div class="col-lg-3" >
            <h3><span style="color: rgb(21, 21, 100)">&#x7C;</span>Search</h3><hr>
             <div class="btn-group" style="display: flex; justify-content: center;">
               <img  src="{!! asset('assets/images/Vectorsearch.png') !!}" width="50px">
             </div>
         </div>
       </div>
     </div>
